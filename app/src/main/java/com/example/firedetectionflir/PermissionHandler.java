...
public class PermissionHandler {
    ...
    @VisibleForTesting
    static String[] PERMISSION_FOR_RECORD_AUDIO = {
            Manifest.permission.RECORD_AUDIO
    };

    @VisibleForTesting
    static String[] PERMISSION_FOR_RECORD_VIDEO = {
            Manifest.permission.WRITE_EXTERNAL_STORAGE,
            Manifest.permission.RECORD_AUDIO
    };
    ...
    public boolean checkForRecordAudioPermission(){
        return checkForPermission(PERMISSION_FOR_RECORD_AUDIO);
    }
    /**
